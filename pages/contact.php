...
<div class="footer">
	<div class="footArrowCont">
		<a href="../index.html"><svg class="footArrow contactFootArrow" enable-background="new 0 0 100 100" id="Layer_1" height="45px" version="1.1" viewBox="0 0 100 100" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><polygon class="footArrowPoly" fill="#fff" points="22.4,64.1 50.8,36.5 79.3,64.1 80.8,63.2 50.8,34.1 20.8,63.2 22.4,64.1 "/></svg></a>
	</div> 
